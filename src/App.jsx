...
import { faFaceGrinTongue as nojinhoSolid } from '@fortawesome/free-solid-svg-icons';
import { faFaceGrinTongue as nojinhoRegular } from '@fortawesome/free-regular-svg-icons';

import { faFaceRollingEyes as tedioSolid } from '@fortawesome/free-solid-svg-icons';
import { faFaceRollingEyes as tedioRegular } from '@fortawesome/free-regular-svg-icons';
...
function App() {
  ...
  const emocoes = [ 
    ...
    { nome: 'Tristeza', descricao:'A tristeza é uma emoção que surge em resposta a experiências negativas, perdas ou decepções.' , imagem: Tristeza, iconSolid: tristezaSolid, iconRegular: tristezaRegular},
    ...
    { nome: 'Ansiedade', descricao:'A ansiedade é um sentimento de preocupação, a tristeza te proteje do que pode acontecer a ansiedade te proteje do que ainda nao aconteceu.' , imagem: Ansiedade, iconSolid: ansiedadeSolid, iconRegular: ansiedadeRegular }
